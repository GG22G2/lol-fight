...
public class ApiRequest {
    ...
    //Api: /lol-champ-select/v1/session/bench/swap/{championId}
    //交换英雄
    ...
    public void banOrPickChamp(int championId, int actionsId) {
        String url = Connect.getConnect().getAddress() + "/lol-champ-select/v1/session/actions/" + actionsId;
        String body = "{" +
    ...
    public InputStream getAllChampions() {
        ...
        String url = Connect.getConnect().getAddress() + "/lol-champions/v1/inventories/" + summonerId + "/champions-minimal";
    ...
    public InputStream getCurrentSummoner() {
        String url = Connect.getConnect().getAddress() + "/lol-summoner/v1/current-summoner";
        return request(url, "GET");
    }
    ...
    public InputStream getImg(int HeadId) {
        String url = Connect.getConnect().getAddress() + "/lol-game-data/assets/v1/profile-icons/" + HeadId + ".jpg";
        return request(url, "GET");
    }
    ...
    private InputStream request(String apiUrl, String method, String requestBody) {
        ...
        HttpRequest httpRequest = HttpRequest.newBuilder()
                ...
                .header("Authorization", Connect.getConnect().getAuthorization())
